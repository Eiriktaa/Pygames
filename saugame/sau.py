from konkurranse_eiriktaa import SauehjerneEiriktaa as Sauehjerne

# from sauehjerne import Sauehjerne

# from sauehjerne_orginal import Sauehjerne
...
class Sau:
    ...
    def __repr__(self):
        return "Sau %d,%d, er_spist: %s" % (
            self._posisjon_venstre,
            self._posisjon_topp,
            self._er_spist,
        )
